...
namespace shareddatalayer
{
    namespace tst
    {
        class HiredisEpollAdapterMock: public redis::HiredisEpollAdapter
        {
        public:
            HiredisEpollAdapterMock(EngineMock& engine, HiredisSystemMock& hiredisSystem) :
                HiredisEpollAdapter(engine, hiredisSystem){}
